...
|---------|-------------|-------|
| Instrukcje | `AGENTS.md` | Ten sam kontrakt na każdym harnessie. `CLAUDE.md` to alias. |
| Skille | `skills/<name>/SKILL.md` | Cienkie linki w `.grok/skills`, `.claude/skills`, `.agents/skills`. [skills/](skills/README.md) |
